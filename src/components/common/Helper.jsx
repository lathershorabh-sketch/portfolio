...
export const ReviewData = [
  {
    ...
    name: "Web Design",
    review:
      "Worked with companies, creating user-friendly, innovative solutions for real-world challenges.",
  },
  {
    svg: <Swipersvg />,
    name: "Software Developer",
    review:
      "Worked on projects, creating efficient, innovative solutions for real-world challenges.",
  },
  {
    svg: <Swipersvg />,
    name: "App Design",
